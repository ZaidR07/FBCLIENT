...
const JoinUs = () => {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef]">
      <Header />
      <div className="w-full mt-[8vh] lg:mt-[10vh] max-w-5xl grid md:grid-cols-2 gap-8 items-center">
        <div className="hidden md:flex flex-col items-center space-y-6">
          <div className="relative w-[80%] aspect-square rounded-lg overflow-hidden bg-gradient-to-br from-[#FF5D00] to-[#FF8C47] p-8 flex items-center justify-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-white/50 backdrop-blur-sm">
                ...
                <p className="text-sm text-gray-600">
                  Be part of cutting-edge projects
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/50 backdrop-blur-sm">
