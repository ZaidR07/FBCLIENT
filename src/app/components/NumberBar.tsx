...
const NumberBar = () => {
  ...
  return (
    <div className="w-full my-[8vh] py-[4vh] bg-[#FF5D00]">
      <ToastContainer
        position="top-center"
      ...
      <div className="flex w-full h-full items-center justify-evenly">
        <div>
          ...
          <br />
          <span className="text-white text-sm">Listed Properties</span>
        </div>
        ...
        <div>
          ...
          <br />
          <span className="text-white text-sm">Active Brokers</span>
        </div>
        ...
        <div>
          ...
          <span className="text-white text-sm"> Happy Users </span>
        </div>
      </div>
    </div>
  );
